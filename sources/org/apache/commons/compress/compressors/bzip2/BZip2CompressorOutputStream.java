...
public class BZip2CompressorOutputStream extends CompressorOutputStream implements BZip2Constants {
    ...
    */
    ...
    private int sendMTFValues1(int i, int i2) {
        ...
        byte[] bArr8 = bArr3[4];
        byte[] bArr9 = bArr3[5];
        int i5 = bZip2CompressorOutputStream.nMTF;
        int i6 = 0;
        int i7 = 0;
        for (int i8 = 4; i6 < i8; i8 = 4) {
            ...
            while (i11 < bZip2CompressorOutputStream.nMTF) {
                int i12 = i11;
                int min = Math.min((i11 + 50) - 1, i5 - 1);
                if (i == 6) {
                    int i13 = i12;
                    short s = 0;
                    short s2 = 0;
    ...
    /* JADX WARN: Type inference failed for: r0v1, types: [java.io.OutputStream, org.apache.commons.compress.compressors.bzip2.BlockSort, org.apache.commons.compress.compressors.bzip2.BZip2CompressorOutputStream$Data] */
