...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((y) message.obj);
                }
            }
        }
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            e.a(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, asBinder);
        ...
        void handleMediaPlayPauseKeySingleTapIfPending(y yVar) {
            if (this.mMediaPlayPauseKeyPending) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(yVar);
                if (z && z3) {
                    onPause();
                } else if (!z && z2) {
                    onPlay();
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            y currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(y yVar);
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        int getRccTransportControlFlagsFromActions(long j) {
            ...
            return (j & 256) != 0 ? rccTransportControlFlagsFromActions | CpioConstants.C_IRUSR : rccTransportControlFlagsFromActions;
        }
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        public final y getCurrentControllerInfo() {
            return new y(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(y yVar) {
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private C.a mVolumeCallback = new C.a() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // androidx.media.C.a
            public void onVolumeChanged(C c) {
                MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                if (mediaSessionImplBase.mVolumeProvider != c) {
                    return;
                }
                MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, c.c(), c.b(), c.a()));
            }
        };
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    C c = MediaSessionImplBase.this.mVolumeProvider;
                    if (i == 2) {
                        int c2 = c.c();
                        int b2 = c.b();
                        streamVolume = c.a();
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new y("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new y(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public y getCurrentControllerInfo() {
            y yVar;
            synchronized (this.mLock) {
                yVar = this.mRemoteUserInfo;
            }
            return yVar;
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(C c) {
            if (c != null) {
                C c2 = this.mVolumeProvider;
                if (c2 != null) {
                    c2.a((C.a) null);
                }
                this.mVolumeType = 2;
                this.mVolumeProvider = c;
    ...
    public static final class Token implements Parcelable {
        ...
        public Bundle toBundle() {
            ...
            if (iMediaSession != null) {
                e.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
            }
    ...
    public void setPlaybackToRemote(C c) {
        if (c != null) {
            this.mImpl.setPlaybackToRemote(c);
            return;
        }
        throw new IllegalArgumentException("volumeProvider may not be null!");
    }
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new y(callingPackage, Binder.getCallingPid(), Binder.getCallingUid()));
            }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(C c) {
            MediaSessionCompatApi21.setPlaybackToRemote(this.mSessionObj, c.d());
        }
