...
public final class l {
    ...
    public static c.a e(TextView textView) {
        ...
        c.a.C0010a c0010a = new c.a.C0010a(new TextPaint(textView.getPaint()));
        if (Build.VERSION.SDK_INT >= 23) {
            c0010a.a(textView.getBreakStrategy());
            c0010a.b(textView.getHyphenationFrequency());
        }
    ...
    private static class a implements ActionMode.Callback {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final ActionMode.Callback f568a;
        ...
        private void a(Menu menu) {
            Context context = this.f569b.getContext();
            ...
            try {
                ...
                for (int i = 0; i < a2.size(); i++) {
                    ...
                    menu.add(0, 0, i + 100, resolveInfo.loadLabel(packageManager)).setIntent(a(resolveInfo, this.f569b)).setShowAsAction(1);
                }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f568a.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f568a.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public void onDestroyActionMode(ActionMode actionMode) {
            this.f568a.onDestroyActionMode(actionMode);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            a(menu);
            return this.f568a.onPrepareActionMode(actionMode, menu);
        }
    ...
    public static void a(TextView textView, androidx.core.f.c cVar) {
        ...
        } else if (e(textView).equals(cVar.a())) {
