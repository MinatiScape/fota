...
public final class u {
    ...
    private static Method f540a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f540a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    private static float d(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f540a) != null) {
            try {
