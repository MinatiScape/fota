...
public class fa {
    ...
    private static final boolean f955a;

    /* renamed from: b  reason: collision with root package name */
    private static final boolean f956b;
    ...
    static class a implements TypeEvaluator<Matrix> {
        ...
        /* renamed from: a  reason: collision with root package name */
        final float[] f957a = new float[9];

        /* renamed from: b  reason: collision with root package name */
        final float[] f958b = new float[9];
        final Matrix c = new Matrix();

        @Override // android.animation.TypeEvaluator
        /* renamed from: a */
        public Matrix evaluate(float f, Matrix matrix, Matrix matrix2) {
            matrix.getValues(this.f957a);
            matrix2.getValues(this.f958b);
            for (int i = 0; i < 9; i++) {
                float[] fArr = this.f958b;
                float f2 = fArr[i];
                float[] fArr2 = this.f957a;
                fArr[i] = fArr2[i] + ((f2 - fArr2[i]) * f);
            }
            this.c.setValues(this.f958b);
            return this.c;
        }
    }

    static {
        f955a = Build.VERSION.SDK_INT >= 19;
        f956b = Build.VERSION.SDK_INT >= 18;
    ...
    */
    private static android.graphics.Bitmap a(android.view.View r9, android.graphics.Matrix r10, android.graphics.RectF r11, android.view.ViewGroup r12) {
        /*
            boolean r0 = androidx.transition.fa.f955a
            r1 = 0
            if (r0 == 0) goto L13
        ...
        L14:
            r2 = 0
        L15:
            boolean r3 = androidx.transition.fa.f956b
            r4 = 0
            if (r3 == 0) goto L34
            if (r0 == 0) goto L34
            if (r2 != 0) goto L1f
        ...
        L35:
            ...
            r10.postScale(r4, r4)
            boolean r11 = androidx.transition.fa.c
            if (r11 == 0) goto L8a
        ...
        L8a:
            ...
            r9.draw(r11)
        L9b:
            boolean r10 = androidx.transition.fa.f956b
            if (r10 == 0) goto Lab
            if (r0 == 0) goto Lab
