...
public class e {
    public static Interpolator a(Context context, int i) throws Resources.NotFoundException {
        ...
        try {
            try {
                if (i == 17563663) {
                    return new a.d.a.a.a();
                }
                if (i == 17563661) {
                    return new a.d.a.a.b();
                }
                if (i == 17563662) {
                    return new a.d.a.a.c();
                }
    ...
    */
    private static android.view.animation.Interpolator a(android.content.Context r2, android.content.res.Resources r3, android.content.res.Resources.Theme r4, org.xmlpull.v1.XmlPullParser r5) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        La1:
            ...
            if (r0 == 0) goto Laf
            androidx.vectordrawable.a.a.h r0 = new androidx.vectordrawable.a.a.h
            r0.<init>(r2, r4, r5)
            goto L3c
        Laf:
        ...
        Lca:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.a.a.e.a(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser):android.view.animation.Interpolator");
    }
}
