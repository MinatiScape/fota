...
public class F extends ListView {
    ...
    private boolean c;
    private androidx.core.h.z d;
    private androidx.core.widget.h e;
    b f;
    ...
    public boolean hasFocus() {
        return this.f249b || super.hasFocus();
    }

    @Override // android.view.View
    public boolean hasWindowFocus() {
        return this.f249b || super.hasWindowFocus();
    }

    @Override // android.view.View
    public boolean isFocused() {
        return this.f249b || super.isFocused();
    }

    @Override // android.view.View
    public boolean isInTouchMode() {
        return (this.f249b && this.f248a) || super.isInTouchMode();
    }
    ...
    */
    public boolean a(android.view.MotionEvent r8, int r9) {
        ...
        L4d:
            if (r3 == 0) goto L65
            androidx.core.widget.h r9 = r7.e
            if (r9 != 0) goto L5a
        ...
        L5a:
            ...
            goto L6c
        L65:
            androidx.core.widget.h r8 = r7.e
            if (r8 == 0) goto L6c
            r8.a(r1)
        L6c:
            return r3
