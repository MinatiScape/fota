...
public class AppCompatViewInflater {
    ...
    private static final Map<String, Constructor<? extends View>> sConstructorMap = new a.b.b();
    ...
    public static class a implements View.OnClickListener {
        ...
        private void a(Context context, String str) {
            ...
            while (context != null) {
                try {
                    if (!context.isRestricted() && (method = context.getClass().getMethod(this.f70b, View.class)) != null) {
                        this.c = method;
                        this.d = context;
                        return;
                    }
            ...
            if (this.f69a.getId() == -1) {
                str2 = "";
            } else {
                str2 = " with id '" + this.f69a.getContext().getResources().getResourceEntryName(id) + "'";
            }
            throw new IllegalStateException("Could not find method " + this.f70b + "(View) in a parent or ancestor Context for android:onClick attribute defined on view " + this.f69a.getClass() + str2);
        }

        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            if (this.c == null) {
                a(this.f69a.getContext(), this.f70b);
            }
            try {
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (context instanceof ContextWrapper) {
            if (Build.VERSION.SDK_INT < 15 || androidx.core.h.t.v(view)) {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        ...
        obtainStyledAttributes.recycle();
        return resourceId != 0 ? ((context instanceof androidx.appcompat.d.d) && ((androidx.appcompat.d.d) context).getThemeResId() == resourceId) ? context : new androidx.appcompat.d.d(context, resourceId) : context;
    }
