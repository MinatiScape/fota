...
public final class R$styleable {
    ...
    public static final int cycle_bg_color = 0;
    public static final int cycle_desc = 1;
    public static final int cycle_desc_margin_top = 2;
    public static final int cycle_desc_text_size = 3;
    public static final int cycle_force_color = 4;
    public static final int cycle_normal_color = 5;
    public static final int cycle_progress_margin_bottom = 6;
    public static final int cycle_progress_text_size = 7;
    public static final int cycle_stroke_width = 8;
    public static final int cycle_sweep_start = 9;
    public static final int cycle_text_font_color = 10;
    public static final int cycle_usable_margin_top = 11;
    public static final int cycle_usable_text_size = 12;
    public static final int view_content = 0;
    public static final int view_icon = 1;
    public static final int view_showBox = 2;
    public static final int view_showSetting = 3;
    ...
    public static final int[] cycle = {R.attr.bg_color, R.attr.desc, R.attr.desc_margin_top, R.attr.desc_text_size, R.attr.force_color, R.attr.normal_color, R.attr.progress_margin_bottom, R.attr.progress_text_size, R.attr.stroke_width, R.attr.sweep_start, R.attr.text_font_color, R.attr.usable_margin_top, R.attr.usable_text_size};
    public static final int[] view = {R.attr.content, R.attr.icon, R.attr.showBox, R.attr.showSetting, R.attr.title};
}
