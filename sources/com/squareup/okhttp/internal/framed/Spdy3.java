...
public final class Spdy3 implements Variant {
    ...
    static final class Writer implements FrameWriter {
        ...
        Writer(BufferedSink bufferedSink, boolean z) {
            ...
            this.headerBlockOut = Okio.a(new DeflaterSink((Sink) this.headerBlockBuffer, deflater));
        }
        ...
        public synchronized void headers(int i, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                int p = (int) (this.headerBlockBuffer.p() + 4);
                this.sink.writeInt(-2147287032);
                this.sink.writeInt((p & 16777215) | 0);
        ...
        public synchronized void synReply(boolean z, int i, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.writeInt(((i2 & 255) << 24) | (p & 16777215));
                this.sink.writeInt(i & Integer.MAX_VALUE);
                this.sink.a(this.headerBlockBuffer);
                this.sink.flush();
            } else {
        ...
        public synchronized void synStream(boolean z, boolean z2, int i, int i2, List<Header> list) throws IOException {
            if (!this.closed) {
                writeNameValueBlockToBuffer(list);
                int p = (int) (this.headerBlockBuffer.p() + 10);
                int i3 = (z ? 1 : 0) | (z2 ? 2 : 0);
                this.sink.writeInt(-2147287039);
                this.sink.writeInt(((i3 & 255) << 24) | (p & 16777215));
                this.sink.writeInt(i & Integer.MAX_VALUE);
