...
public final class FramedStream {
    ...
    public final class FramedDataSink implements Sink {
        ...
        private void emitDataFrame(boolean z) throws IOException {
            ...
            synchronized (FramedStream.this) {
                ...
                min = Math.min(FramedStream.this.bytesLeftInWriteWindow, this.sendBuffer.p());
                FramedStream.this.bytesLeftInWriteWindow -= min;
            }
            FramedStream.this.writeTimeout.enter();
            try {
                FramedStream.this.connection.writeData(FramedStream.this.id, (z && min == this.sendBuffer.p()) ? true : $assertionsDisabled, this.sendBuffer, min);
            } finally {
                FramedStream.this.writeTimeout.exitAndThrowIfTimedOut();
            }
        }
    ...
    public final class FramedDataSource implements Source {
        ...
        private void waitUntilReadable() throws IOException {
            ...
            while (this.readBuffer.p() == 0 && !this.finished && !this.closed && FramedStream.this.errorCode == null) {
                try {
                    FramedStream.this.waitForIo();
                } finally {
        ...
        public long read(Buffer buffer, long j) throws IOException {
            if (j >= 0) {
                synchronized (FramedStream.this) {
                    ...
                    long read = this.readBuffer.read(buffer, Math.min(j, this.readBuffer.p()));
        ...
        void receive(BufferedSource bufferedSource, long j) throws IOException {
            ...
            while (j > 0) {
                synchronized (FramedStream.this) {
                    z = this.finished;
                    z2 = true;
                    z3 = this.readBuffer.p() + j > this.maxByteCount;
                }
                if (z3) {
