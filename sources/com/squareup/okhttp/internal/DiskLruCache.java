...
public final class DiskLruCache implements Closeable {
    ...
    private BufferedSink newJournalWriter() throws FileNotFoundException {
        return Okio.a(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile)) { // from class: com.squareup.okhttp.internal.DiskLruCache.2
            static final /* synthetic */ boolean $assertionsDisabled = false;
    ...
    private void readJournal() throws IOException {
        BufferedSource a2 = Okio.a(this.fileSystem.source(this.journalFile));
        try {
            String d = a2.d();
            String d2 = a2.d();
            String d3 = a2.d();
            String d4 = a2.d();
            String d5 = a2.d();
            if (!MAGIC.equals(d) || !VERSION_1.equals(d2) || !Integer.toString(this.appVersion).equals(d3) || !Integer.toString(this.valueCount).equals(d4) || !"".equals(d5)) {
                throw new IOException("unexpected journal header: [" + d + ", " + d2 + ", " + d4 + ", " + d5 + "]");
            }
            int i = 0;
            while (true) {
                try {
                    readJournalLine(a2.d());
                    i++;
    ...
    public synchronized void rebuildJournal() throws IOException {
        ...
        BufferedSink a2 = Okio.a(this.fileSystem.sink(this.journalFileTmp));
